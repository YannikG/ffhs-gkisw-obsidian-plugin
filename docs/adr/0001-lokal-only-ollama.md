...
**Begründung:** Datenschutz und Datenhoheit, keine laufenden API-Kosten, Unabhängigkeit von Anbieter-Verfügbarkeit; passt zum lokalen Markdown-Ansatz von Obsidian. Cloud-Variante technisch möglich, widerspricht aber PRD-NF01/NF02 und MVP-Scope (SPEC §1).
